...
.page-header { background: url(https://easetemplate.com/free-website-templates/hike/images/pageheader.jpg)no-repeat;  background-size: cover; }
.page-caption { padding-top: 60px; padding-bottom: 300px; color:#fff  }
.page-title {  line-height: 1; color: #fff; text-align: center; }
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <section class="py-5 text-center">
                            <div class="container"> 
                                <h2 class="text-center">Entretenimiento Luckmmoshy </h2>
                                <p class="text-muted mb-5 text-center">Te ofrecemos libros y peliculas que te interesará conocer.</p>
                            </div>
                       </section>
                        </div>
                        <!-- /.section-title -->
